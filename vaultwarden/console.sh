...
ADMINTOKEN=`openssl rand -base64 48 && echo $ADMINTOKEN > admintoken.pwd && chmod 600 admintoken.pwd`
...
export ROCKET_TLS
ADMIN_TOKEN=`openssl rand -base64 48 && echo $ADMINTOKEN > admintoken.pwd && chmod 600 admintoken.pwd`
export ADMIN_TOKEN
